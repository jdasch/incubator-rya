...
public class FluoQueryMetadataDAO {
    ...
    private FilterMetadata.Builder readFilterMetadataBuilder(final SnapshotBase sx, final String nodeId) {
        ...
        return FilterMetadata.builder(nodeId).setVarOrder(varOrder).setOriginalSparql(originalSparql)
                .setFilterIndexWithinSparql(filterIndexWithinSparql).setParentNodeId(parentNodeId).setChildNodeId(childNodeId);
    }
