 ...
 */
public class AccumuloLoadStatementsFilePCJIT extends FluoITBase {

    @Test(expected = InstanceDoesNotExistException.class)
    public void instanceDoesNotExist() throws Exception {
        final AccumuloConnectionDetails connectionDetails = createConnectionDetails();

        final RyaClient ryaClient = AccumuloRyaClientFactory.build(connectionDetails, accumuloConn);
    ...
    public void loadTurtleFile() throws Exception {
        ...
        final Scanner scanner = accumuloConn.createScanner(getRyaInstanceName() + "spo", new Authorizations());
    ...
    @Test
    public void loadTurtleFile2() throws Exception {
        // Install an instance of Rya.
        final InstallConfiguration installConfig = InstallConfiguration.builder()
                .setEnableTableHashPrefix(false)
                .setEnableEntityCentricIndex(false)
