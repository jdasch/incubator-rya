...
public class AccumuloLoadStatementsFile extends AccumuloCommand implements LoadStatementsFile {
    ...
    @Override
    public void loadStatements(final String ryaInstanceName, final File statementsFile, final RDFFormat format, final boolean flushEachUpdate) throws InstanceDoesNotExistException, RyaClientException {
        ...
        try {
        	...
        	//final AccumuloGetInstanceDetails details = new AccumuloGetInstanceDetails(getAccumuloConnectionDetails(), getConnector());
        	//final AccumuloRdfConfiguration ryaConf = AccumuloInstall.makeRyaConfig(getAccumuloConnectionDetails(), details.getDetails(ryaInstanceName).get());
            ...
            sailRepoConn.add(statementsFile, null, format);
