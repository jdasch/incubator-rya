...
public class AccumuloExecuteSparqlQuery extends AccumuloCommand implements ExecuteSparqlQuery {
	...
	public String executeSparqlQuery(final String ryaInstanceName, final String sparqlQuery)
        ...
        try {
        	...
        	//final AccumuloGetInstanceDetails deets = new AccumuloGetInstanceDetails(getAccumuloConnectionDetails(), getConnector());
        	//final AccumuloRdfConfiguration ryaConf = AccumuloInstall.makeRyaConfig(getAccumuloConnectionDetails(), deets.getDetails(ryaInstanceName).get());
